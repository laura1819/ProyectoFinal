...
<html>
    ...
    <body>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" >
                <h1>Ejercicio LoginLogoff &nbsp&nbsp&nbsp&nbsp&nbsp 
           <input type="submit" name="salir" value="Salir" class="boton_personalizados"><br><br></h1>	 </form>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" >
                ...
                <div>
                    <table style="margin: 0 auto;">                                               
                        ...
                        <tr>
                            <td></td>
                            <td><input type="radio" name="Buscar" id="Alta" value="Alta"<?php
