            ...
            $codigo=$_GET['CodDepartamento'];
             try {                           
                    ...
                    <form style="text-align: center;" action="<?php echo $_SERVER["PHP_SELF"]?>" method="post">
                        ...
                        <input type="button" name="cancelar" class="boton_personalizados" value="Cancelar" onclick="location='logind.php'">
                        <input type="submit" name="Aceptar" class="boton_personalizado" value="Aceptar">    
                    </form>
        
                    <?php
                    if(isset($_POST['Aceptar'])){
                        echo "<script>alert('REHABILITADO!!!!');window.location.href='logind.php';</script>";
                    }
