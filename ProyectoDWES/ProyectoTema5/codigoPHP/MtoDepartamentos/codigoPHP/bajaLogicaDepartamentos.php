        ...
        $fechaActual=strftime("%Y-%m-%d"); //le pasamos como queremos que nos muestre la hora
            ...
            if (isset($_POST['Aceptar'])) { //Si pulsamos aceptar haremos lo siguiente
                try{
                    ...
                    echo "<script>alert('Formato no correcto: AAAA-MM-DD');window.location.href='logind.php';</script>"; // sacamos el mensaje de error y le damos el formato
                }
                
                
                echo "<script>alert('DADO DE BAJA!!!');window.location.href='logind.php';</script>"; // si esta todo bien lo indicamos
            } else {
                ?>
